...
def main():
  ...
  csv_file_path = os.path.join(script_dir, 'twitter_account_ids_set6.csv')
    ...
    for row in reader:
      ...
      while retry_times < 3:
        try:
          ...
          if retry_times >= 3:
            with open('error_tweet_accounts_exception_6.txt','a') as f:
